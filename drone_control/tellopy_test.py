...
#go down
def down(command, delay=1):
  send("down 25", delay)

#go left
def left(command, delay=1):
  send("left 25", delay)

#go right
def right(command, delay=1):
  send("right 25", delay)

#go forward
def forward(command, delay=1):
  send("forward 25", delay)

#go backwards
def backwards(command, delay=1):
  send("back 25", delay)
